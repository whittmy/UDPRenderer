...
namespace ee
{
    ...
    public:
        ...
        void setModelTrans(glm::mat4 modelTrans) { m_modelTrans = modelTrans; m_normalModelTrans = glm::transpose(glm::inverse(modelTrans)); }
        glm::mat4 getModelTrans() const { return m_modelTrans; }
        glm::mat4 getNormalModelTrans() const { return m_normalModelTrans; }
